...
from experiments.sidarthe_mobility_experiment import MobilitySidartheExperiment
from learning_models.tied_sidarthe_extended import TiedSidartheExtended
from learning_models.mobility_sidarthe import SidartheMobility
...
if __name__ == "__main__":
    ...
    experiment_cls = MobilitySidartheExperiment  # switch class to change experiment: e.g. SidartheExperiment
    ...
    experiment.run_exp(
        ...
        model_params={"der_1st_reg": 1e5, "bound_reg": 5e5, "bound_loss_type": "step", "model_cls": SidartheMobility},
